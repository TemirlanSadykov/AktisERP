...
DATABASES = {
    'default': {
        'ENGINE': config('PROD_MONAMISS_DB_ENGINE'),
        'NAME': config('PROD_MONAMISS_DB_NAME'),
        'USER': config('PROD_MONAMISS_DB_USER'),
        'PASSWORD': config('PROD_MONAMISS_DB_PASSWORD'),
        'HOST': config('PROD_MONAMISS_DB_HOST'),
        'PORT': config('PROD_MONAMISS_DB_PORT'),
    }
}
...
CSRF_TRUSTED_ORIGINS = ['https://prod-monamiss.up.railway.app']
