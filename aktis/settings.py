...
DATABASES = {
    'default': {
        'ENGINE': config('MAHABAT_DB_ENGINE'),
        'NAME': config('MAHABAT_DB_NAME'),
        'USER': config('MAHABAT_DB_USER'),
        'PASSWORD': config('MAHABAT_DB_PASSWORD'),
        'HOST': config('MAHABAT_DB_HOST'),
        'PORT': config('MAHABAT_DB_PORT'),
    }
}
